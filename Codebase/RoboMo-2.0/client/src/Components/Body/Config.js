        ...
        <div className="flex flex-col gap-4">
          <div className="flex flex-col gap-2">
            ...
            <select
              value={useCaseValue}
              onChange={getUseCase}
              className="border px-3 py-2 text-sm rounded w-full focus:outline-none text-black"
            >
          ...
          <div className="flex flex-col gap-2">
            ...
            <div className="flex items-center gap-2">
              <input
                type="number"
                className="border px-3 py-2 rounded w-full focus:outline-none text-black"
                placeholder="1000"
          ...
          <div className="flex justify-end gap-3 pt-2">
            <button
              ...
              className={`rounded text-sm px-4 py-2 ${
                darkMode
                  ? "bg-[#304463] text-white hover:bg-[#223247]"
                  : "bg-[#f5f6f9] text-gray-900 border border-gray-200 hover:border-gray-300"
              }`}
            >
              Apply
            </button>
            <button
              ...
              className={`rounded text-sm px-4 py-2 ${
                darkMode
                  ? "bg-[#50698f] text-white border border-gray-600 hover:bg-gray-700 hover:border-gray-600"
